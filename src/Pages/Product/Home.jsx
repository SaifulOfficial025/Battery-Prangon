      ...
      <main className="flex-grow py-8 bg-white">
        <Container>
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="w-full md:w-[260px] lg:w-[280px] flex-shrink-0">
            ...
            <div className="flex-grow w-full flex flex-col gap-6">
              ...
              <div className="relative w-full">
                <input
                  ...
                  className="w-full bg-[#f1f1f1] text-slate-800 placeholder-slate-400 py-3 pl-6 pr-12 focus:outline-none focus:ring-1 focus:ring-[#C51C1C] text-sm font-normal"
                />
                <button
                  type="button"
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-655 hover:text-black transition-colors"
                  aria-label="Search"
                >
              ...
              {filteredProducts.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center mt-2">
