...
function Sidebar({ 
  ...
  return (
    <aside className="w-full max-w-[280px] bg-[#fdfdfd] border border-gray-100 p-6 flex flex-col gap-8 select-none">
      ...
      <div className="flex flex-col">
        ...
        <button
          ...
          className="flex items-center justify-between w-full text-left font-sans font-bold text-[#1a1a1a] text-lg hover:opacity-80 transition-opacity focus:outline-none"
        >
          <span>Product Category</span>
          <FiChevronDown 
            className={`text-xl text-slate-800 transition-transform duration-300 ${
        ...
        {/* Divider */}
        <div className="w-full h-[1px] bg-gray-200/60 mt-3.5 mb-5" />
          ...
          {categories.map((item) => {
            ...
            return (
              <div
                ...
                className="flex items-center gap-4.5 cursor-pointer py-0.5 group"
              >
                {/* Radio Circle Indicator */}
                {isSelected ? (
                  <div className="w-[18px] h-[18px] rounded-full bg-[#C51C1C] flex-shrink-0 flex items-center justify-center transition-all duration-200" />
                ) : (
                  <div className="w-[18px] h-[18px] rounded-full border-2 border-slate-600 flex-shrink-0 transition-colors duration-200 group-hover:border-slate-850" />
                )}
                
                {/* Label Text */}
                <span 
                  className={`text-[15px] font-bold tracking-wide transition-colors duration-200 ml-2 ${
